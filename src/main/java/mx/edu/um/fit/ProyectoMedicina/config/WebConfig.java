...
public class WebConfig extends WebMvcConfigurerAdapter{
     ...
     */
    @Bean
    public MessageSource messageSource() { //Cambia de idioma en las páginas web (Lo hace sitio multi idioma)
    ...
    public MultipartResolver multipartResolver() {// Subir archivos
        ...
        multipartResolver.setMaxUploadSize(500000);//Tamaño máximo de subida
